                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">Dodaj Nowy Produkt</div>
                        ...
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="addproduct()">
                                <div class="md-3 mt-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Wpisz nazwe towaru" wire:model="name" wire:keyup="generateSlug">
                                    @error('name')
                                ...
                                <div class="md-3 mt-3">
                                    ...
                                    <input type="text" name="slug" class="form-control" placeholder="Wpisz slug" wire:model="slug">
                                    @error('slug')
                                    <p class="text-danger">{{$message}} </p>
                                    @enderror
                                </div>
