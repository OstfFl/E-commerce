                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Propozycja 'Trade-in'</h4>
                                    <h2 class="animated fw-900">Zniżki </h2>
                                    <h1 class="animated fw-900 text-brand">Na wsyzstkie produkty</h1>
                                    <p class="animated">Zaoszczędź aż do 70% tylko dzwoniąc do nas!</p>
                                    <a class="animated btn btn-brush btn-brush-3" href="{{route('shop')}}"> Do Zakupów </a>
                                </div>
                            </div>
                ...
                <div class="single-hero-slider single-animation-wrap">
                    <div class="container">
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Gorące Zniżki</h4>
                                    <h2 class="animated fw-900">Na Modną Odzież</h2>
                                    <h1 class="animated fw-900 text-7">Z Ostatniej Kolekcji</h1>
                                    <p class="animated">Zniżki aż do 20% </p>
                                    <a class="animated btn btn-brush btn-brush-2" href="{{route('shop')}}">Sprawdź teraz</a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
...
{{--                            <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one" type="button" role="tab" aria-controls="tab-one" aria-selected="true">Ciekawe</button>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item" role="presentation">--}}
{{--                            <button class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two" type="button" role="tab" aria-controls="tab-two" aria-selected="false">Popularne</button>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item" role="presentation">--}}
{{--                            <button class="nav-link" id="nav-tab-three" data-bs-toggle="tab" data-bs-target="#tab-three" type="button" role="tab" aria-controls="tab-three" aria-selected="false">Nowe</button>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
{{--                    <a href="{{route('shop')}}" class="view-more d-none d-md-flex">Pokaż więcej<i class="fi-rs-angle-double-small-right"></i></a>--}}
{{--                </div>--}}
{{--                <!--End nav-tabs-->--}}
...
{{--                                            <a aria-label="Dodaj do Listy Zyczeń" class="action-btn hover-up" href="wishlist.php"><i class="fi-rs-heart"></i></a>--}}
...
{{--                                            <a aria-label="Dodaj do Kosza" class="action-btn hover-up" href="cart.html"><i class="fi-rs-shopping-bag-add"></i></a>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                    <a aria-label="Dodaj do Listy Zyczeń" class="action-btn small hover-up" href="wishlist.php" tabindex="0"><i class="fi-rs-heart"></i></a>--}}
...
{{--        </section>--}}
        ...
        <section class="section-padding">
            <div class="container">
                <h3 class="section-title mb-20 wow fadeIn animated"><span>Wybrane</span> Brandy</h3>
