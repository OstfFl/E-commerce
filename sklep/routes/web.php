...
Route::middleware(['auth','authadmin'])->group(function(){
    ...
    Route::get('/admin/users',\App\Http\Livewire\Admin\AdminUsersListComponent::class)->name('admin.users');
    Route::get('/admin/orders',\App\Http\Livewire\Admin\OrdersListComponent::class)->name('admin.orders');
});
